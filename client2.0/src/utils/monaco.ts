...
const haskellLanguageConfiguration: languages.LanguageConfiguration = {
  comments: {
    lineComment: "//",
    blockComment: ["/*", "*/"],
  },
...
const haskellMonarchTokensProvider: languages.IMonarchLanguage = {
  module: /^(module)\b/,
  import: /^(import)\b/,
  ...
  datatype: /[A-Z][\w]+/,
  datatypekey:
    /Int|Float|Text|Int16|Int64|Double|Char|Text|CI Text|ByteString|Bool|Day|UTCTime|LocalTime|TimeOfDay|Value|Json|JsonStr|UUID|Maybe|Vector|CustomType|GenInnerTy|Rep/,
  functions: /[a-z]+/,
  datacons: /[A-Z][\w]+/,
  typcons: /\s*[A-Z][\w]+/,
  text: /[A-Z][\w]+/,
  ...
  typevar: /[a-z][\w]+/,
  reservedid:
    /qualified|hiding|case|default|deriving|do|else|if|import|in|infix|infixr|let|of|then|type|where|show|_/,
  tokenizer: {
    root: [
    ...
    typcons: [
      ...
      [
        /[A-Z][\w]+(?=\s*[a-z]\w*\s*?[a-z]\w*\s*?[a-z]\w*\s*?\,)/,
        "classname",
        "@types",
      ],
      [
        /[A-Z][\w]+(?=\s*[a-z]\w*\s*?[a-z]\w*\s*?[a-z]\w*\s*?[a-z]\w*\s*?\,)/,
        "classname",
        "@types",
      ],
      [
      ...
      [
        /[A-Z][\w]*(?=\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*\,)/,
        "classname",
        "@types",
      ],
    ...
    typeinstance: [
      ...
      [
        /[a-z][\w]*(?=\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?\:\:)/,
        "cl",
        "@typconss",
      ],
      [
        /[a-z][\w]*(?=\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?\:\:)/,
        "cl",
        "@typconss",
      ],
      [
        /[a-z][\w]*(?=\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?[a-z][\w]*\s*?\:\:)/,
        "cl",
        "@typconss",
      ],
      [/\(/, "open"],
    ...
    disk: [
      ...
      [/[a-z][\w]+(?=\s*[a-z]\w*\s*?\:\:)/, "binderad", "@typconss"],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
      [
        /[a-z][\w]+(?=\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\s*[a-z]\w*\s*?\:\:)/,
        "binderad",
        "@typconss",
      ],
