...
TOP		= /Users/alexandershilen/poetrymachine/interpreter
...
FFILibDir=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.3.sdk/usr/lib
FFIIncludeDir=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.3.sdk/usr/include/ffi
...
LdHasFilelist = YES
ArArgs = qcls
HaskellHostOs = OSDarwin
HaskellHostArch = ArchX86_64
HaskellTargetOs = OSDarwin
...
SettingsHaskellCPPFlags = -E -undef -traditional -Wno-invalid-pp-token -Wno-unicode -Wno-trigraphs
SettingsCCompilerFlags = --target=x86_64-apple-darwin 
SettingsCxxCompilerFlags = --target=x86_64-apple-darwin 
SettingsCCompilerLinkFlags = --target=x86_64-apple-darwin  
SettingsCCompilerSupportsNoPie = NO
SettingsLdCommand = ld
SettingsLdFlags = 
...
MERGE_OBJS_STAGE0 = ld
MERGE_OBJS_STAGE1 = ld
MERGE_OBJS_STAGE2 = ld
MERGE_OBJS_STAGE3 = ld
...
CONF_CC_OPTS_STAGE0 = 
CONF_CC_OPTS_STAGE1 = --target=x86_64-apple-darwin 
CONF_CC_OPTS_STAGE2 = --target=x86_64-apple-darwin 
CONF_GCC_LINKER_OPTS_STAGE0 = 
CONF_GCC_LINKER_OPTS_STAGE1 = --target=x86_64-apple-darwin  
CONF_GCC_LINKER_OPTS_STAGE2 = --target=x86_64-apple-darwin  
...
CPP			= gcc -E 
HS_CPP			= gcc -E -undef -traditional -Wno-invalid-pp-token -Wno-unicode -Wno-trigraphs
